...
import { 
  ...
  AlertTriangle, Info, Power, PowerOff
} from 'lucide-react'
...
export function RuleBuilder() {
  ...
  const { rules, getActiveRules, getRulesByType, toggleRuleActive } = useRulesStore()
                      ...
                      <div className="flex items-center justify-between mb-3">
                        ...
                        {activeRules.length > 1 && (
                          <Button
                            size="sm"
                            variant="ghost"
                            onClick={() => activeRules.forEach(rule => toggleRuleActive(rule.id))}
                  ...
                  {inactiveRules.length > 0 && (
                    <div className="pt-4 border-t border-gray-100">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        {inactiveRules.length > 1 && (
                          <Button
                            size="sm"
                            variant="ghost"
                            onClick={() => inactiveRules.forEach(rule => toggleRuleActive(rule.id))}
                      ...
                      <div className="space-y-2">
                        {inactiveRules.map(rule => (
                          <div
                            key={rule.id}
                            className="p-3 border rounded-lg border-gray-100 bg-gray-50 transition-all duration-200 hover:bg-gray-100 hover:border-gray-200"
                          >
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="p-6">
              ...
              <Tabs defaultValue="aiAssistant" className="space-y-6">
                <TabsList className="grid w-full grid-cols-7 h-auto p-1 bg-gradient-to-r from-slate-50 to-gray-100">
                  <TabsTrigger 
                    value="aiAssistant" 
                    className="flex flex-col items-center gap-2 py-4 px-3 data-[state=active]:bg-purple-100 data-[state=active]:border-purple-300 border border-transparent"
                  >
                  ...
                  <TabsTrigger 
                    value="coRun" 
                    className="flex flex-col items-center gap-2 py-4 px-3 data-[state=active]:bg-blue-100 data-[state=active]:border-blue-300 border border-transparent"
                  >
                    <div className="p-2 bg-blue-100 rounded-lg">
                    ...
                    {coRunRules.length > 0 && (
                      <Badge variant="outline" className="text-xs h-4 border-blue-300 text-blue-600">
                        {coRunRules.length}
                      </Badge>
                    )}
                  </TabsTrigger>
                  ...
                  <TabsTrigger 
                    ...
                    className="flex flex-col items-center gap-2 py-4 px-3 data-[state=active]:bg-green-100 data-[state=active]:border-green-300 border border-transparent"
                  >
                    ...
                    {slotRestrictionRules.length > 0 && (
                      <Badge variant="outline" className="text-xs h-4 border-green-300 text-green-600">
                  ...
                  <TabsTrigger 
                    value="loadLimit" 
                    className="flex flex-col items-center gap-2 py-4 px-3 data-[state=active]:bg-amber-100 data-[state=active]:border-amber-300 border border-transparent"
                  >
                    ...
                    {loadLimitRules.length > 0 && (
                      <Badge variant="outline" className="text-xs h-4 border-amber-300 text-amber-600">
                  ...
                  <TabsTrigger 
                    value="phaseWindow" 
                    className="flex flex-col items-center gap-2 py-4 px-3 data-[state=active]:bg-indigo-100 data-[state=active]:border-indigo-300 border border-transparent"
                  >
                    ...
                    {phaseWindowRules.length > 0 && (
                      <Badge variant="outline" className="text-xs h-4 border-indigo-300 text-indigo-600">
                  ...
                  <TabsTrigger 
                    value="patternMatch" 
                    className="flex flex-col items-center gap-2 py-4 px-3 data-[state=active]:bg-pink-100 data-[state=active]:border-pink-300 border border-transparent"
                  >
                    ...
                    {patternMatchRules.length > 0 && (
                      <Badge variant="outline" className="text-xs h-4 border-pink-300 text-pink-600">
                  ...
                  <TabsTrigger 
                    ...
                    className="flex flex-col items-center gap-2 py-4 px-3 data-[state=active]:bg-red-100 data-[state=active]:border-red-300 border border-transparent"
                  >
                    ...
                    {precedenceOverrideRules.length > 0 && (
                      <Badge variant="outline" className="text-xs h-4 border-red-300 text-red-600">
